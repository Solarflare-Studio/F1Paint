...
function createColourpicker() {
	...
	const forcedheightofcolourpicker = window.innerHeight * 0.05;
...
function onPatternPicked(which,thefile,thepatternelement)
{
	...
	// new html
//	newPatternClicked(thepatternelement);
	//
	...
	if(currentLayer==0)
		document.getElementById('layer1patterns_ins').classList.add('oldhtmldisabledButton');
	else if(currentLayer==1)
		document.getElementById('layer2tags_ins').classList.add('oldhtmldisabledButton');
	else if(currentLayer==2)
		document.getElementById('layer3sponsors_ins').classList.add('oldhtmldisabledButton');
...
function setMaterial(glosstype,theChan) {
	...
	if(glosstype==0) { // gloss
		document.getElementById('glossbutton').classList.add('oldhtmlwhiteButton');
		document.getElementById('mattebutton').classList.remove('oldhtmlwhiteButton');
		document.getElementById('metallicbutton').classList.remove('oldhtmlwhiteButton');
	}
	else if(glosstype==1) { // matte
		document.getElementById('glossbutton').classList.remove('oldhtmlwhiteButton');
		document.getElementById('mattebutton').classList.add('oldhtmlwhiteButton');
		document.getElementById('metallicbutton').classList.remove('oldhtmlwhiteButton');
	}
	else if(glosstype==2) { // metallic
		document.getElementById('glossbutton').classList.remove('oldhtmlwhiteButton');
		document.getElementById('mattebutton').classList.remove('oldhtmlwhiteButton');
		document.getElementById('metallicbutton').classList.add('oldhtmlwhiteButton');
	}
}
...
window.handlePaintTutorial = handlePaintTutorial

window.handleTagTutorial = handleTagTutorial
window.handleSponsorTutorial = handleSponsorTutorial
...
// ben temp fix for launchar back
function removeExtraPages() {
	document.getElementById("prevBtn").classList.remove("hidden");
	document.getElementById("nextBtn").classList.remove("hidden");
	document.getElementById("launchar").classList.add("hidden");
