...
class F1AssetFileNames {
    ...
    constructor() {
        ...
        this.car_files = [ './assets/car/F1PS_F1_Car_V10_Rev2.glb',            // 3d model glb
                            ...
                            './assets/car/01_StaticMainMaps/V10/1k/F1PS_Car_Static_V10_1k_BaseColor.jpg',      // static base map always stays the same
                            './assets/car/01_StaticMainMaps/V10/F1PS_Car_Static_V10_Normal.jpg',         // static base normal
                            './assets/car/01_StaticMainMaps/V10/F1PS_Car_Static_V10_AO.jpg',             // static base ao
                            './assets/car/01_StaticMainMaps/V10/F1PS_Car_Static_V10_Metal.jpg',          // static base metal
                            './assets/car/01_StaticMainMaps/V10/F1PS_Car_Static_V10_Roughness.jpg'   ];  // static base rough
