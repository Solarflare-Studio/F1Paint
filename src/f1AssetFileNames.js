...
class F1AssetFileNames {
    ...
    constructor() {
        ...
        this.car_files = [ './assets/car/F1PS_F1_Car_V10.glb',            // 3d model glb
                            ...
                            './assets/car/custom/V10/1k/F1PS_Car_Custom_V10_1k_Normal.jpg',        // customisable normal
                            './assets/car/custom/V10/1k/F1PS_Car_Custom_V10_1k_AO.jpg',            // customisable ao
                            './assets/car/custom/V10/2k/F1PS_Car_Custom_V10_2k_Metal.jpg',         // customisable metal // not loaded
                            './assets/car/custom/V10/2k/F1PS_Car_Custom_V10_2k_Roughness.jpg',     // customisable rough // not loaded
                            './assets/car/static/V10/2K/F1PS_Car_Static_V10_2k_BaseColor.jpg',      // static base map always stays the same
                            './assets/car/static/V10/1k/F1PS_Car_Static_V10_1k_Normal.jpg',         // static base normal
                            './assets/car/static/V10/1k/F1PS_Car_Static_V10_1k_AO.jpg',             // static base ao
                            './assets/car/static/V10/1k/F1PS_Car_Static_V10_1k_Metal.jpg',          // static base metal
                            './assets/car/static/V10/1k/F1PS_Car_Static_V10_1k_Roughness.jpg'   ];  // static base rough
