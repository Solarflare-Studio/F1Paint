...
class F1AssetFileNames {
    ...
    constructor() {
        ...
        this.car_files = [ './assets/car/F1PS_F1_Car_V07_CapUV.glb',            // 3d model glb
                            './assets/textures/smallblackimage.jpg',     // customisable base colour map
                            './assets/car/custom/F1PS_Car_Custom_V07_Normal.jpg',        // customisable normal
                            './assets/car/custom/F1PS_Car_Custom_V07_AO.jpg',            // customisable ao
                            './assets/car/custom/F1PS_Car_Custom_V07_Metal.jpg',         // customisable metal
                            './assets/car/custom/F1PS_Car_Custom_V07_Roughness.jpg',     // customisable rough
